...
export class Email extends Message {
    ...
    sentOn: number // was: DateTime
    receivedOn: number // was: DateTime
    ...
    _writeToStorage(): void {
        ...
        if (this.sentOn == null) this.sentOn = Date.now()

        // TODO: receivedOn.HasValue?
        if (this.receivedOn != null)
            this._topLevelProperties.addProperty(PropertyTags.PR_MESSAGE_DELIVERY_TIME, this.receivedOn)

        // was SentOn.Value.ToUniversalTime()
        this._topLevelProperties.addProperty(PropertyTags.PR_CLIENT_SUBMIT_TIME, this.sentOn)
