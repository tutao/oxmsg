export const enum MessageImportance {
    IMPORTANCE_LOW = 0,
    IMPORTANCE_NORMAL = 1,
    IMPORTANCE_HIGH = 2,
}

export const enum MessageIconIndex {
    NewMail = 0x00000000,
    Post = 0x00000001,
    Other = 0x00000003,
    ReadMail = 0x00000100,
...
export type AddressType = "" | "EX" | "SMTP" | "FAX" | "MHS" | "PROFS" | "X400"

export const enum MapiObjectType {
...
export const enum RecipientRowDisplayType {
    // A messaging user
    MessagingUser = 0x00,
    // A distribution list
...
export const enum RecipientFlags {
...
export const enum PropertyFlag {
...
export enum MessageEditorFormat {
...
export const enum StoreSupportMask {
...
export const StoreSupportMaskConst =
    StoreSupportMask.STORE_ATTACH_OK | // | StoreSupportMask.STORE_CATEGORIZE_OK
