...
export class Properties extends Array<Property> {
	...
	addDateProperty(tag: PropertyTagsEnum,
		...
		if (tag.id === PropertyTags.PR_CLIENT_SUBMIT_TIME.id) {
			console.log("submit time date:", value.toString())
		}
	}
	...
	addProperty(
		...
		switch (tag.type) {
			...
			case PropertyType.PT_SYSTIME:
				...
				if (tag.id === PropertyTags.PR_CLIENT_SUBMIT_TIME.id) {
					console.log("submit time bytes:", lower.toString(16).padStart(4, "0"), upper.toString(16).padStart(4, "0"))
				}
				break
