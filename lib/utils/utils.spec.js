...
import {bigInt64FromParts, bigInt64ToParts, byteBufferAsUint8Array, fileNameToDosFileName, makeByteBuffer} from "./utils.js";
...
o.spec('utils', function () {
	...
	let bigints = [
		[0n, {lower: 0, upper: 0}],
		[1n, {lower: 1, upper: 0}],
		[42n, {lower: 42, upper: 0}],
		[9001n, {lower: 9001, upper: 0}],
		[0x00000000ffffffffn, {lower: 0xffffffff, upper: 0}],
		[0x7000000000000000n, {lower: 0, upper: 0x70000000}],
		[0xffffffffffffffffn, {lower: 0xffffffff, upper: 0xffffffff}],
		[0xfedcba0987654321n, {lower: 0x87654321, upper: 0xfedcba09}],
		[0x2020202000000000n, {lower: 0, upper: 0x20202020}],
		[0x0000000020202020n, {lower: 0x20202020, upper: 0}],
		[0xdeadbeef0000bbbbn, {lower: 0x0000bbbb, upper: 0xdeadbeef}],
		[0x1234567890abcdefn, {lower: 0x90abcdef, upper: 0x12345678}],
