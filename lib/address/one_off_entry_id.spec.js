...
const {OneOffEntryId} = require('./one_off_entry_id')
const {uint8ToBase16} = require('../../test/utils')

o.spec("OneOffEntryId", function () {
    o("test value serialization", function () {
        const ooei = new OneOffEntryId("peterpan@neverland.com", "", "SMTP", 2, false, true)
        const buf = ooei.toByteArray()
        const expect = ('00000000812b1fa4bea310199d6e00dd' +
